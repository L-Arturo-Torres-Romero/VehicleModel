Project Description. You can find the [📄  Documentation (PDF)](docs/manual.pdf) (In development) here. Try open it from Matlab online: [![Open in MATLAB Online](https://www.mathworks.com/images/responsive/global/open-in-matlab-online.svg)](https://matlab.mathworks.com/open/github/v1?repo=L-Arturo-Torres-Romero/VehicleModel&project=https://github.com/L-Arturo-Torres-Romero/VehicleModel/blob/master/Installers/VehicleDynamicsPlayGround/VehicleModel.mlproj)
