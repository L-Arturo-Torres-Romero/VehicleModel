...
% Load Data
file1 = 'VehiclePose_NoDisturbance.mat'; % Replace with your actual filenames
file2 = 'VehiclePose_WithDisturbance.mat';
...
%plot(values2X, values2Y, 'b-.', 'LineWidth', 0.8); % Green line
